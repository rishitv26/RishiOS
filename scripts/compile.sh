...
dd if=bin/bin/boot.bin of=rishios.img bs=512 count=1 conv=notrunc && # slap in the bootloader...
dd if=bin/bin/loader.bin of=rishios.img bs=512 count=5 seek=1 conv=notrunc && # slap in the loader...

...
dd if=bin/bin/user.bin of=boot.img bs=512 count=10 seek=106 conv=notrunc && # slap in usr1...
dd if=bin/bin/user2.bin of=boot.img bs=512 count=10 seek=116 conv=notrunc && # slap in usr2...
clear &&

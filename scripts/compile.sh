...
dd if=bin/bin/gc.bin of=boot.img bs=512 count=10 seek=106 conv=notrunc && # slap in usr1...
dd if=bin/bin/np.bin of=boot.img bs=512 count=10 seek=116 conv=notrunc && # slap in usr2...
dd if=bin/bin/default.bin of=boot.img bs=512 count=10 seek=126 conv=notrunc && # slap in usr2...
